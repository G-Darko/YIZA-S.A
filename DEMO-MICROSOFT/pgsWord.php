...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu"> 
            ...
            <a onclick="Swal.fire({
                    title: 'Tu codigo de examen es: <b>Nc986#f=0!<b>',
                    showClass: {
                ...
                <div class="option">
                    ...
                    <h4>Generar código de examen WORD</h4>
                </div>
            </a>
    ...
    <main>
          ...
          <img class="lgo_1" src="imagenes/word.png"> 
                <img class="banW" src="imagenes/bannerW.jpg">
                    
               
<br><br><br>
    <div class="container_videos">
            <!-- <video src="videos/CURSO DE WORD 2019.mp4"></video> -->
            <iframe src="videos/CURSO DE WORD 2019.mp4"></iframe>
    </div>
